...
*/
export declare module Exitgames.Common {
    class Logger {
        private prefix;
        private level;
        /**
...
*/
export declare module Photon.LoadBalancing {
...
*/
export declare module Photon.Lite.Constants {
    const LiteOpKey: {
        ActorList: number;
        ActorNr: number;
...
export declare module Photon.LoadBalancing.Constants {
    /**
...
*/
export declare module Photon.Chat.Constants {
    const ParameterCode: {
        Channels: number;
        Channel: number;
        Messages: number;
...
*/
export declare module Photon.Chat {
    /**
