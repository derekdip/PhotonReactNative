            ...
            */
            Room.prototype.setEmptyRoomLiveTime = function (emptyRoomLiveTime) {
                if (this.emptyRoomLiveTime != emptyRoomLiveTime) {
                    if (this.setProp(LoadBalancing.Constants.GameProperties.EmptyRoomTtl, Photon.TypeExt.Int(emptyRoomLiveTime) /*, TypeExt.Int(this.emptyRoomLiveTime)*/)) // No CAS by design, also expected = 0 is not supported by server currently
            ...
            */
            Room.prototype.setSuspendedPlayerLiveTime = function (suspendedPlayerLiveTime) {
                if (this.suspendedPlayerLiveTime != suspendedPlayerLiveTime) {
                    if (this.setProp(LoadBalancing.Constants.GameProperties.PlayerTtl, Photon.TypeExt.Int(suspendedPlayerLiveTime) /*, TypeExt.Int(this.suspendedPlayerLiveTime)*/)) // No CAS by design, also expected = 0 is not supported by server currently
